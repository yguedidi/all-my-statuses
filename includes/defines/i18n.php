<?php
	...
	define('I18N_TEXT_INVITE_TITLE', 16);
	define('I18N_TEXT_INVITE_DESC', 17);
	define('I18N_TEXT_INVITE_CLOSE', 18);
	define('I18N_TEXT_REQUEST_INVITE_TITLE', 19);
	define('I18N_TEXT_REQUEST_INVITE_BODY', 20);
